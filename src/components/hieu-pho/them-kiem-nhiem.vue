    ...
    <div v-if="isOpen" class="modal-overlay">
        <div class="add-modal">
            <div class="add-modal__content">
                ...
                <label for="">
                    Chọn nhiệm vụ:
                    <select v-model="MaNV" name="" id="">
                        <option disabled value="">-- Chọn nhiệm vụ --</option>
                        <option v-for="nv in danhSachNhiemVu" :key="nv.MaNV" :value="nv.MaNV">
                            {{nv.TenNV}}
                        </option>
                    </select>

                    <div v-if="phanCongChuNhiem">
                        <p>
                            <span class="alert-text">LƯU Ý:</span> 
                            Nếu bạn phân công chủ nhiệm cho giáo viên, hệ thống sẽ tự động phân công cho cả năm
                        </p>
                    </div>
                </label>
                ...
                <div class="modal-actions">
                    ...
                    <button @click="them_kiem_nhiem">Thêm</button>
                </div> 
            </div>
        </div>
    </div>
...
export default {
    ...
    methods: {
        ...
        async hien_danh_sach_nhiem_vu(){
            try{
                const response = await axios.get(`${API_BASE_URL}/nhiem-vu/danh-sach-nhiem-vu`)
        ...
        them_kiem_nhiem(){
            ...
            const kiemNhiemMoi = {
                ...
                MaNV: this.MaNV,
                HocKy: this.hocKyDuocChon,
                NamHoc: this.namHocDuocChon
            }
            console.log(kiemNhiemMoi)
            this.$emit('save', kiemNhiemMoi)
            this.reset()
        }
    },
}
