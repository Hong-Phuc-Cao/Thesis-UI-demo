<template>
    <div :class="['sidebar', { 'sidebar-collapsed': !isOpen }]">
        <div class="sidebar-header">
            ...
            <h2 v-if="isOpen">Hiệu phó</h2>
        </div>
        <div class="sidebar-main" v-if="isOpen">
            <div class="sidebar-content">

                <div class="dropdown-single">
                    <router-link to="/hieu-pho/phan-cong-hieu-pho" class="dropdown-single-button">
                        <span>Phân công giảng dạy</span>
                    </router-link>
                </div>

                <div class="dropdown-single">
                    <router-link to="/hieu-pho/kiem-nhiem" class="dropdown-single-button">
                        <span>Phân công kiêm nhiệm</span>    
                    </router-link>
                </div>

                <div class="dropdown-single">
                    <router-link to="/hieu-pho/giu-chuc-vu" class="dropdown-single-button">
                        <span>Phân công chức vụ</span>
                    </router-link>
                </div>
                ...
                <div class="dropdown-single">
                    <router-link to="/hieu-pho/chuong-trinh" class="dropdown-single-button">
