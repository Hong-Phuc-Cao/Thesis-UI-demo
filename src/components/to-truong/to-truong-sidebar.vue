<template>
    <div :class="['sidebar', { 'sidebar-collapsed': !isOpen }]">
        <div class="sidebar-header">
            ...
            <h2 v-if="isOpen">Tổ trưởng</h2>
        </div>
        <div class="sidebar-main" v-if="isOpen">
            <div class="sidebar-content">
                <div class="dropdown-single">
                    <router-link to="/to-truong/phan-cong-chuyen-mon" class="dropdown-single-button">
...
export default {
    ...
    methods: {
        ...
        //     try {
        //         const response = await axios.get(`http://localhost:3000/api/v1/dang-nhap/lay-thong-tin-session`, {
